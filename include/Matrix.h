...
template <std::size_t rowCount, std::size_t colCount> class Matrix {
private:
  float *components;

public:
  Matrix() { components = new float[rowCount * colCount](); }
  ...
  Matrix<rowCount, colCountOther>
  operator*(const Matrix<colCount, colCountOther> &other) {
